...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etEmailUsuario = findViewById(R.id.ptEmailUsuario);
        etSenhaUsuario = findViewById(R.id.ptSenhaUsuario);
            ...
            public void onClick(View v) {
                ...
                try {
                    usuario = new Usuario(-1,
                            ...
                            etEmailUsuario.getText().toString(), Integer.parseInt(etSenhaUsuario.getText().toString()));
        ...
        bAtualizarUsuario.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Bloco try para "tentar" executar as ações esperadas. O catch é para "remediar" ou "avisar" algo que não foi realizado no bloco try como esperado.
                try {
                    usuario = new Usuario(Integer.parseInt(etCodigoUsuario.getText().toString()), etNomeUsuario.getText().toString(), etEmailUsuario.getText().toString(), Integer.parseInt(etSenhaUsuario.getText().toString()));
